...
public class TestLoad {
	...
	public static void main(String[] args) {
		...
		IAbsenceDao abscenceDao = context.getBean(IAbsenceDao.class);
		...
		List<Formateur> formateurs = utilisateurDao.findByDispoAndMatiere("Java Objet", LocalDate.of(2022, Month.JANUARY, 24),
				LocalDate.of(2022, Month.JANUARY, 25));

		System.out.println("nombre de formateurs dispo : " + formateurs.size());
